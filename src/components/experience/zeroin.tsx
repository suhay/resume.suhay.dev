    ...
    <div className='job'>
      ...
      <ul>
        ...
        <li>
          ...
          from the ground up releasing a web app in the summer of 2024 and a mobile app soon after.
        </li>
        <li>
          Developed a <strong>custom recommendation engine</strong> that uses{' '}
          <strong>machine learning</strong> to suggest products based on a user's preferences and
